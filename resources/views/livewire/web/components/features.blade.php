    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div class="p-4 bg-gray-100 rounded-lg shadow">
                <div
                    class="flex justify-center items-center mb-4 w-10 h-10 rounded bg-violet-900 lg:h-12 lg:w-12 dark:bg-violet-100">
                    <svg class="w-5 h-5 text-violet-200 lg:w-6 lg:h-6 dark:text-violet-600" fill="currentColor"
